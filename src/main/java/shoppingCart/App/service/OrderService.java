...
//
//        User user = this.orderRepository.findByEmail(username)
...
//        //find cart
//        Cart cart= this.cartRepository.findById(cartId).orElseThrow(()->new ResourceNotFountException("Cart Not Found"));
//
//        //getting CartItem
...
//            throw new ResourceNotFountException("Plz Add Cart First and place Order");
//        }
//
//
